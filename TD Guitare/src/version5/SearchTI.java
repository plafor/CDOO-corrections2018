...
public class SearchTI {
	...
	public void testSpecificGuitar() {
		GuitarSpec whatCustomerWant = new GuitarSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, 6, Wood.ALDER,
				Wood.ALDER);
	...
	public void testSpecificMandolin() {
		MandolinSpec whatCustomerWant = new MandolinSpec(Builder.FENDER, "Stratocastor", Style.A, Type.ELECTRIC,
	...
	public void testElectricGuitar() {
		GuitarSpec whatCustomerWant = new GuitarSpec(null, "", Type.ELECTRIC, GuitarSpec.NO_PREF_NUM_STRINGS, null,
				null);
		List matchingInstruments = inventory.search(whatCustomerWant);
	...
	public void testAcousticGuitar() {
		GuitarSpec whatCustomerWant = new GuitarSpec(null, null, Type.ACOUSTIC, GuitarSpec.NO_PREF_NUM_STRINGS, null,
				null);
		List matchingInstruments = inventory.search(whatCustomerWant);
	...
	public void testNoMachingGuitar() {
		GuitarSpec whatCustomerWant = new GuitarSpec(Builder.COLLINGS, null, Type.ACOUSTIC, 12, null,
	...
	public void testNoMachingMandolin() {
		MandolinSpec whatCustomerWant = new MandolinSpec(Builder.COLLINGS, null, Style.F, Type.ACOUSTIC, null,
				Wood.BRAZILIAN_ROSEWOOD);
		List matchingInstruments = inventory.search(whatCustomerWant);
