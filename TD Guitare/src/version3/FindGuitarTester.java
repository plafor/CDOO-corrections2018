...
public class FindGuitarTester {
	...
	public static void main(String[] args) {
		...
		List<Guitar> guitars = mySuperInventory.search(whatErinLikes);

		if (!guitars.isEmpty()) {
			for (Guitar guitar : guitars) {
				System.out.println("Erin, you might like this " + guitar.getSpecs().getBuilder() + " " + guitar.getSpecs().getModel() + " "
						+ guitar.getSpecs().getType() + " guitar:\n   " + guitar.getSpecs().getBackWood() + " back and sides,\n   "
